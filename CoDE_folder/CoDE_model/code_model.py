...
class VITContrastiveHF(nn.Module):
    ...
    def __init__(self, classificator_type):
        ...
        self.model = transformers.AutoModel.from_pretrained("aimagelab/CoDE", use_safetensors=True)
        self.model.pooler = nn.Identity()
        self.classificator_type = classificator_type
        self.processor = transformers.AutoProcessor.from_pretrained("aimagelab/CoDE", use_safetensors=True)
...
if __name__ == "__main__":
    ...
    model = VITContrastiveHF(
        classificator_type=classificator_type
    )
